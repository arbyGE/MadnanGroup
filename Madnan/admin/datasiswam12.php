...
<body>
  ...
  <div>
   ...
   <button><a href="datasiswaorm12.php" style="text-decoration: none">INDUSTRI</a></button> 
<table border="2" align="center">
    ...
    while ($tampil = mysqli_fetch_array($ambil)){
        ...
        <td>$no</td>
            ...
            <td><a style=color:black;font-size:20px;text-decoration:none;font-family:Arial; href='editsiswa12.php?kode=$tampil[nisn]'>Ubah</a></td>
...
<?php
            if(isset($_GET['kode'])){
                mysqli_query($koneksi, "delete from siswa2 where nisn ='$_GET[kode]'");
