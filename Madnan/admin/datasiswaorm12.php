...
<table border="2" align="center">
    ...
    while ($tampil = mysqli_fetch_array($ambil)){
        ...
        <td>$no</td>
            ...
            <td><a style=color:black;font-size:20px;text-decoration:none;font-family:Arial; href='editsiswaorm12.php?kode=$tampil[nisn]'>ubah</a></td>
...
<?php
            if(isset($_GET['kode'])){
                mysqli_query($koneksi, "delete from siswa6 where nisn ='$_GET[kode]'");
...
<li><button style="margin-top:10;"><a href="inputsiswaor12.php" style="text-decoration: none;">TAMBAH DATA</a></button></li>
</body>
</html>
</body>
</html>